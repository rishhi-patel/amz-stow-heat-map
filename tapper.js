...
(function() {
    ...
    const WORKFLOW = [{
            type: "run",
            fn: () => configureFirstStepOptions()
        },
        {
            type: "click",
            selector: "#submitButton button"
        },
        {
            type: "click",
            selector: ".view-thumb"
        ...
        {
            type: "click",
            selector: SHOW_HEAT_MAP_SELECTOR
        },
        {
            type: "run",
            fn: () => showOtherTabs()
    ...
    function configureFirstStepOptions() {
        ...
        document.querySelector('.group-bins option[value="Aisle"]').selected = true
        document.querySelector('.group-bins option[value="Aisle"]').dispatchEvent(new Event('change', {
            bubbles: true
        }))
    ...
    if (document.readyState === "complete" || document.readyState === "interactive") {
        ...
        window.addEventListener("DOMContentLoaded", () => startWorkflowLoop(), {
            once: true
        })
    }
})()
